...
fn random_spheres() {
    ...
    //let ground_material = Rc::new(Rc::new(Lambertian::new(Color::new(0.5,0.5,0.5));
...
fn two_spheres() {
    ...
    world.add(Rc::new(Sphere::new(vec3::vec_from_tuple((0.0,-10.0,0.0)), 10.0, Rc::new(Lambertian::from_texture(checker.clone())))));
    world.add(Rc::new(Sphere::new(vec3::vec_from_tuple((0.0, 10.0,0.0)), 10.0, Rc::new(Lambertian::from_texture(checker)))));
...
fn final_scene(image_width:i32, samples_per_pixel:i32, max_depth:i32) {
    ...
    world.add(Rc::new(Sphere::new(Vec3::new(260.0, 150.0, 45.0), 50.0, Rc::new(Dielectric::new(1.5)))));
    world.add(Rc::new(Sphere::new(Vec3::new(0.0, 150.0, 145.0), 50.0, Rc::new(Metal::new(Color::new(0.8, 0.8, 0.9),1.0)))));

    let boundary = Rc::new(Sphere::new(Vec3::new(360.0, 150.0, 145.0), 70.0, Rc::new(Dielectric::new(1.5))));
    world.add(boundary.clone());
    world.add(Rc::new(ConstantMedium::from_color(boundary, 0.2, Color::new(0.2, 0.4, 0.9))));
    let boundary = Rc::new(Sphere::new(Vec3::new(0.0, 0.0, 0.0), 5000.0, Rc::new(Dielectric::new(1.5))));
    ...
    world.add(Rc::new(Sphere::new(Vec3::new(220.0, 280.0, 300.0), 80.0, Rc::new(Lambertian::from_texture(pertext)))));
